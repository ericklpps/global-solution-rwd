export default function Acoes (){
    ...
    <h1 className="text-center text-6xl font-bold mb-6">Ação Praia Grande</h1>
    <br/>
        <img src="lixo-praiag.jpg" alt="mostrar lixo no mar e praia" className="mx-auto w-full max-w-lg rounded-lg shadow-lg"/>
        <p className="text-gray-600 mt-2 text-center">Foto: Reprodução/ Rafael Pazzine - Praia Grande - SP</p>
        <br/>
    <section className="bg-gray-100 p-6 rounded shadow-lg mb-6">
      <h2 className="text-3xl font-bold mb-4">Sobre a Praia Grande</h2>
      <p className="mb-4">
    ...
    <section className="bg-gray-100 p-6 rounded shadow-lg mb-6">
      <h2 className="text-3xl font-bold mb-4">Nosso Projeto</h2>
      <p className="mb-4">
      ...
      <h3 className="text-2xl font-bold mb-4">Pontos de Coleta nas Seguintes Praias:</h3>
      ...
      <div className="text-center mt-4">
        <a href="#" className="bg-blue-700 text-white px-4 py-2 rounded-md hover:bg-blue-800">Clique para se voluntariar</a>
      </div>
    </section>
    </main>
</>
